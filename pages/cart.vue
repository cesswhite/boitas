<template>
  <div class="h-auto">
    ...
    <div v-else class="flex mx-auto mt-64 max-w-screen-2xl gap-10">
      <div class="flex flex-col w-1/2">
        <h3 class="font-medium text-xl text-gray-700">Productos</h3>
        <div class="grid gap-4 grid-cols-5 items-center justify-end">
          <span class="font-bold text-center col-start-4 inline-block"
            >Cantidad</span
          >
        ...
        <div class="divide-y flex flex-col">
          ...
          >
            <img
              ...
              alt=""
              class="rounded-xl object-contain md:h-40 md:w-40"
            />
